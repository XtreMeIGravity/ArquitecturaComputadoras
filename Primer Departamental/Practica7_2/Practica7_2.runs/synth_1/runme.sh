...
HD_PWD='C:/Arquitectura de Computadoras/Primer Departamental/Practica7_2/Practica7_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MemProgram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MemProgram.tcl
