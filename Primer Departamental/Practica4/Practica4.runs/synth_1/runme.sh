...
HD_PWD='C:/Arquitectura de Computadoras/Primer Departamental/Practica4/Practica4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SumadorAcarreoAnticipado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SumadorAcarreoAnticipado.tcl
