...
HD_PWD='F:/Proyectos/Arquitectura de Computadoras/Primer Departamental/Practica6/Practica6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Registro16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Registro16.tcl
