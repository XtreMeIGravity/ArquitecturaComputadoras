...
HD_PWD='C:/Arquitectura de Computadoras/Primer Departamental/Practica3/Practica3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRCompleto.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRCompleto.tcl
